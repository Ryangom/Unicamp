...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="my-3">Total Student</h1>
          </div>
        </div>
      </div>
    </div>
  ...
  if (isset($_POST['SD_submit'])) {
    ...
    if ($name=='' ||$address=='' || $email==''|| $mobile_num==''|| $gender==''|| $date=='') {
     ...
     $a=mysqli_query($conn,$check);
      ...
      $pass="123";
      $hash=md5($pass);
      $sql="INSERT INTO `users` (`Full_name`, `Address`, `Email`, `Gender`,`dob`,`Contact_number`,`Profile_pic`,`Password`,`Role_id`) VALUES ('".$name."', '".$address."', '".$email."','".$gender."','".$date."','".$mobile_num."','".$filename."','".$hash."',1);";
...
?>
            ...
            <div class="card">
              <div class="card-header border-transparent">
                ...
                <h1 class="card-title text-center"><strong class="text-primary display-4">All Student</strong></h1>
              </div>
              <!-- /.card-header -->
        ...
        $sn=1;
          while($row = mysqli_fetch_array($result)){
            ?>
              ...
              <td class="std_id" hidden><?php echo $row['User_id']?></td> 
              ...
              <td>
                <a href="delete.php?userID=<?php echo $row['User_id']?>" class="delete_btn" name="btn_delet" data-toggle="modal" data-target="#exampleModal"  type="submit" name="edit" class="btn btn-danger">Delete</a> 
                <!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Delele</button> -->
              </td>
          </tr>
          <?php
              $sn++;  
     ...
     <div class="card-footer clearfix">
                ...
                <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="submit" name="SD_submit" class="btn btn-primary">Save</button>
                            </div>
